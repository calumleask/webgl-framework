...
export class Program {
  ...
  constructor() {
    (this._program = null), (this._uniformSetters = {});
    this._attribSetters = {};
  }
  ...
  createProgram(
    ...
    (this._program = program), (this._uniformSetters = uniformSetters);
  ...
  private _createAttribSetters(
    glContext: WebGL2RenderingContext,
    program: WebGLProgram,
  ): AttributeSetters {
    const attribSetters: AttributeSetters = {};
    const attribCount = glContext.getProgramParameter(
      program,
      glContext.ACTIVE_ATTRIBUTES,
    );
